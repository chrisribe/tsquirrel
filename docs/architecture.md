...
| 18 | Premium R&D workflow (translation as minor bonus): deep analysis first + optional language output + private embargo/public release | 🟡 partial | Direction now clarified in `docs/product-specs/2026-09-08-rd-priority-monetization.md`: keep free authority lane open and monetize with per-request priority deep dives first. Translation remains a minor add-on; embargo/public controls stay in scope for later phase. |
