...
| 18 | Extra Context first; paid R&D deferred | ⬜ todo | Active scope: [Extra Context KISS plan](product-specs/2026-09-08-extra-context-mvp-plan.md) — user-selected story, manual Hermes research, API draft, admin approval, free appended section. No queue, worker, membership, or payments. [Monetization ideas](product-specs/2026-09-08-rd-priority-monetization.md) are deferred reference only. |
